...
이 문서는 서버 상태와 클라이언트 상태의 관리 책임 및 API 호출과 UI의 분리를 정의한다.

# 연관 관계

- 제품 기술 구성 근거 참조: @.docs/prd/opinion-brief-technology-summary.md
- JavaScript 규칙 참조: @.claude/rules/harness/technical/03-javascript.md
...
- 하네스 `.claude/rules/harness/technical/03-javascript.md` (상태·API·UI 책임 분리)
